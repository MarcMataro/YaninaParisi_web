...
$faqModel = new Faq($conn);
	...
	// Map categories a noms llegibles (català)
	$catNames = [
	    'general' => 'General',
	    'terapia' => 'Terapia',
	    'tarifes' => 'Tarifes',
	...
	foreach ($faqs as $f) {
		$q = trim(strip_tags($f['pregunta_ca']));
		$a = trim(strip_tags($f['resposta_ca']));
		if ($q === '' || $a === '') continue;
...
<head>
	...
	<title>Preguntes freqüents - Yanina Parisi</title>
	<meta name="description" content="Preguntes freqüents sobre els serveis i funcionament de la consulta de Yanina Parisi.">
		...
		<section class="contact-hero">
			...
			<div class="container">
				<div class="contact-hero-content">
					...
					<p class="contact-hero-subtitle">Resolem els dubtes més habituals sobre serveis, tarifes i reserves.</p>
				</div>
			</div>
		</section>
	...
	<main>
		...
		<section class="faq-section">
			<div class="container">
				<div class="faq-list">
					<?php if (empty($faqs)): ?>
						<p>No hi ha preguntes freqüents disponibles.</p>
					<?php else:
						...
						<div class="faq-category">
							...
							<?php foreach ($items as $f): ?>
								<details class="faq-item" id="faq-<?php echo $f['id_faq']; ?>">
									<summary><?php echo htmlspecialchars($f['pregunta_ca']); ?></summary>
									<div class="faq-body"><?php echo $f['resposta_ca']; ?></div>
								</details>
							<?php endforeach; ?>
						</div>
